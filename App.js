    ...
    <div className="font-sans">
      ...
      <section className="py-16 bg-gray-100 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-10 px-6">
          <img src="https://www.upsinverter.com/utl/wp-content/uploads/2020/08/UTL-Offgrid-Solar-Inverter.jpg" className="rounded-xl"/>
          <img src="https://nativtechniks.com/wp-content/uploads/2024/05/How-Businesses-in-the-Philippines-Can-Gain-Competitive-Edge-with-Solar-Power-820x445.jpg" className="rounded-xl"/>
          <img src="https://external-preview.redd.it/rzRZyXradF213d43bbHTFLxeIHgqtv2hXR23Y83h2Lk.jpg?auto=webp&s=beb4255f7fcb58e95452540fdb1986265d1ff0f2" className="rounded-xl"/>
        </div>
      </section>
      ...
      <section className="bg-yellow-500 text-white text-center py-16">
        ...
        <p className="mt-2">
          Message us now and get a custom quote
        </p>
